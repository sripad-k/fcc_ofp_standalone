...
typedef struct {
    ...
    uint16_t ads_flags;
    uint32_t px4_time_ms;
    int16_t px4_eul_rpy[3];
    float px4_omg[3];
    float px4_acc[3];
    int16_t px4_vel_ned[3];
    uint32_t px4_lat;
    uint32_t px4_lon;
    float px4_alt_amsl;
    float px4_alt_baro;
    int16_t px4_aspd1_cas;
    int16_t px4_aspd2_cas;
    uint8_t px4_gnss_n_sat;
    uint8_t px4_gnss_fix_type;
    uint16_t px4_gnss_h_acc;
    uint16_t px4_gnss_v_acc;
    uint16_t px4_flags;
