...
int serdes_pack_ss_log(const serdes_ss_log_t *packet, uint8_t *buffer, uint16_t max_size) {
    ...
    offset += sizeof(uint16_t);
    memcpy(buffer + offset, &packet->px4_time_ms, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer + offset, packet->px4_eul_rpy, sizeof(int16_t) * 3);
    offset += sizeof(int16_t) * 3;
    memcpy(buffer + offset, packet->px4_omg, sizeof(float) * 3);
    offset += sizeof(float) * 3;
    memcpy(buffer + offset, packet->px4_acc, sizeof(float) * 3);
    offset += sizeof(float) * 3;
    memcpy(buffer + offset, packet->px4_vel_ned, sizeof(int16_t) * 3);
    offset += sizeof(int16_t) * 3;
    memcpy(buffer + offset, &packet->px4_lat, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer + offset, &packet->px4_lon, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer + offset, &packet->px4_alt_amsl, sizeof(float));
    offset += sizeof(float);
    memcpy(buffer + offset, &packet->px4_alt_baro, sizeof(float));
    offset += sizeof(float);
    memcpy(buffer + offset, &packet->px4_aspd1_cas, sizeof(int16_t));
    offset += sizeof(int16_t);
    memcpy(buffer + offset, &packet->px4_aspd2_cas, sizeof(int16_t));
    offset += sizeof(int16_t);
    memcpy(buffer + offset, &packet->px4_gnss_n_sat, sizeof(uint8_t));
    offset += sizeof(uint8_t);
    memcpy(buffer + offset, &packet->px4_gnss_fix_type, sizeof(uint8_t));
    offset += sizeof(uint8_t);
    memcpy(buffer + offset, &packet->px4_gnss_h_acc, sizeof(uint16_t));
    offset += sizeof(uint16_t);
    memcpy(buffer + offset, &packet->px4_gnss_v_acc, sizeof(uint16_t));
    offset += sizeof(uint16_t);
    memcpy(buffer + offset, &packet->px4_flags, sizeof(uint16_t));
    offset += sizeof(uint16_t);
...
int serdes_unpack_ss_log(const uint8_t *buffer, uint16_t buffer_size, serdes_ss_log_t *packet) {
    ...
    offset += sizeof(uint16_t);
    memcpy(&packet->px4_time_ms, buffer + offset, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(packet->px4_eul_rpy, buffer + offset, sizeof(int16_t) * 3);
    offset += sizeof(int16_t) * 3;
    memcpy(packet->px4_omg, buffer + offset, sizeof(float) * 3);
    offset += sizeof(float) * 3;
    memcpy(packet->px4_acc, buffer + offset, sizeof(float) * 3);
    offset += sizeof(float) * 3;
    memcpy(packet->px4_vel_ned, buffer + offset, sizeof(int16_t) * 3);
    offset += sizeof(int16_t) * 3;
    memcpy(&packet->px4_lat, buffer + offset, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(&packet->px4_lon, buffer + offset, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(&packet->px4_alt_amsl, buffer + offset, sizeof(float));
    offset += sizeof(float);
    memcpy(&packet->px4_alt_baro, buffer + offset, sizeof(float));
    offset += sizeof(float);
    memcpy(&packet->px4_aspd1_cas, buffer + offset, sizeof(int16_t));
    offset += sizeof(int16_t);
    memcpy(&packet->px4_aspd2_cas, buffer + offset, sizeof(int16_t));
    offset += sizeof(int16_t);
    memcpy(&packet->px4_gnss_n_sat, buffer + offset, sizeof(uint8_t));
    offset += sizeof(uint8_t);
    memcpy(&packet->px4_gnss_fix_type, buffer + offset, sizeof(uint8_t));
    offset += sizeof(uint8_t);
    memcpy(&packet->px4_gnss_h_acc, buffer + offset, sizeof(uint16_t));
    offset += sizeof(uint16_t);
    memcpy(&packet->px4_gnss_v_acc, buffer + offset, sizeof(uint16_t));
    offset += sizeof(uint16_t);
    memcpy(&packet->px4_flags, buffer + offset, sizeof(uint16_t));
    offset += sizeof(uint16_t);
