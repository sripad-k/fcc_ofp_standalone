/** @file
 *  @brief MAVLink comm protocol generated from lodd.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_LODD_H
#define MAVLINK_LODD_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_LODD.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_LODD_XML_HASH 477296370638232422
