...
#define MAVLINK_LODD_XML_HASH -3398669375135308922
...
typedef enum LDE_STATUS
{
   ...
   LDE_STATUS_FTS_ACTIVE=256, /* FTS status, 0: FTS disabled, 1: FTS enabled (HV disabled) | */
   LDE_STATUS_ENUM_END=257, /*  | */
} LDE_STATUS;
#endif
...
/** @brief flags for INS data */
#ifndef HAVE_ENUM_LDE_INS_FLAGS
#define HAVE_ENUM_LDE_INS_FLAGS
typedef enum LDE_INS_FLAGS
{
   LDE_INS_TIMEOUT=1, /* INS data timeout | */
   LDE_INS_FLAGS_ENUM_END=2, /*  | */
} LDE_INS_FLAGS;
#endif

/** @brief flags from lodd_gnc */
#ifndef HAVE_ENUM_LDE_RADALT_FLAGS
#define HAVE_ENUM_LDE_RADALT_FLAGS
typedef enum LDE_RADALT_FLAGS
{
   LDE_RADALT_TIMEOUT=1, /* Radalt data timeout | */
   LDE_RADALT_FLAGS_ENUM_END=2, /*  | */
} LDE_RADALT_FLAGS;
#endif
