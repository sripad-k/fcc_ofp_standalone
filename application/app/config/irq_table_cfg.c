...
//void TickHandler(const Uint32_t parameter);			// SW Interrupt tick handler
//void TickHandler2(const Uint32_t parameter);		// FW Interrupt tick handler

/***** Constants ********************************************************/

const d_INT_IrqVectorTable_t IrqVectorTable[MAXIMUM_IRQ] =
{
...
/* Shared peripheral Interrupts */
     ...
     {NULL, 0},//{Discrete_Pl_Handler, 7},           /* 142 - XPS_FPGA14_INT_ID */
...
const Uint32_t SchedulerInterrupt = XPS_FPGA2_INT_ID;
//const Uint32_t SchedulerInterrupt = XPS_TTC0_0_INT_ID;
