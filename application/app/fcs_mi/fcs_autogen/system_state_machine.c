...
#define system_state_machine_IN_GPS_loss_timer_triggered ((uint8_T)4U)
...
static void system_state_machine_phh325i5jc(const real_T *TrigonometricFunction6,
  const boolean_T *Switch1, const real_T rtu_sensor_eul_ang[3], const real_T
  ...
  *rtu_pilot_input_switch_1, const boolean_T *rtu_wp_data_wp_list_valid, vom_t
  *rty_vom_status, busMode_data *rty_mode_data, boolean_T *rty_sFlags_bGPSLoss,
  boolean_T *rty_sFlags_rampup_phase, boolean_T
  *rty_sFlags_bTelemtryLinkLoss1sec, boolean_T *rty_sFlags_ep_loss1sec, uint8_T *
  rty_loiter_mode, pic_t *rty_pic_status);
...
static void system_state_machine_fhrgqlbunr(const real_T *TrigonometricFunction6,
  const boolean_T *FixPtRelationalOperator, const boolean_T
  *FixPtRelationalOperator_cwrqbb5ufj, const vom_t *vom_status, const boolean_T *
  Switch1, const real_T *Switch, const real_T rtu_sensor_eul_ang[3], const
  real_T rtu_sensor_pos_lla[3], const real_T *rtu_sensor_aspd_cas, const real_T *
  rtu_sensor_h_radar_agl, const real_T *rtu_sensor_chi, const int8_T
  *rtu_pilot_input_switch_1, const real_T *rtu_controllerAltCtrl_forceDes, const
  uint8_T *rtu_extd_cmd_tecs_cmd, const boolean_T *rtu_wp_data_wp_list_valid,
  ...
  rtu_dist, real_T rtu_heading, real_T *rty_latOut, real_T *rty_lonOut)
{
  ...
  *rty_latOut = asin(u0);
   ...
   *  Sum: '<S54>/Add2'
   *  Trigonometry: '<S54>/Trigonometric Function6'
   *  Trigonometry: '<S54>/Trigonometric Function7'
   *  Trigonometry: '<S54>/Trigonometric Function8'
   */
  ...
  rtu_LLA2[3], real_T *rty_distance)
{
  ...
  /* MATLAB Function 'pos_NED/ECEF2NED/MATLAB Function1': '<S49>:1' */
  /* '<S49>:1:6' cos_lat = cos(LLA(1)); */
  cos_lat_tmp = cos(rtu_LLA1[0]);

  /* '<S49>:1:7' sin_lat = sin(LLA(1)); */
  sin_lat_tmp = sin(rtu_LLA1[0]);

  /* '<S49>:1:8' cos_long = cos(LLA(2)); */
  cos_long_tmp = cos(rtu_LLA1[1]);

  /* '<S49>:1:9' sin_long = sin(LLA(2)); */
  sin_long_tmp = sin(rtu_LLA1[1]);

  /* Product: '<S52>/Product' incorporates:
   *  Constant: '<S52>/e'
   */
  /* '<S49>:1:10' C = [-sin_lat * cos_long, -sin_lat * sin_long,  cos_lat;... */
  /* '<S49>:1:11'                    -sin_long,            cos_long,        0;... */
  /* '<S49>:1:12'          -cos_lat * cos_long, -cos_lat * sin_long, -sin_lat]; */
  ...
  *rty_mode_data)
{
  ...
  /* '<S8>:2709:3' vom_status=vom_t.B_TRANS; */
  *rty_vom_status = B_TRANS;
  ...
  *rty_mode_data)
{
  ...
  /* '<S8>:2820:1' sf_internal_predicateOutput = vom_cmd==vom_t.LOITER; */
  if (system_state_machine_B.Switch_d533txexjk == LOITER) {
    /* Transition: '<S8>:2820' */
    system_state_machine_DW.is_FW_Modes = system_state_machine_IN_Loiter_Mode;

    /* Entry 'Loiter_Mode': '<S8>:2748' */
    /* '<S8>:2748:3' vom_status = vom_t.LOITER; */
    *rty_vom_status = LOITER;
    ...
    *heading_ieyh5igw0r = *rtu_sensor_chi;
    ...
    /* '<S8>:2799:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER || goto_back_trans; */
  } else if ((system_state_machine_B.Switch_d533txexjk == HOVER) ||
    ...
    /* Transition: '<S8>:2824' */
    /* '<S8>:2798:1' sf_internal_predicateOutput = vom_cmd==vom_t.FW_RTH... */
    /* '<S8>:2798:2' || bTelemtryLinkLoss5sec==true; */
  } else if ((system_state_machine_B.Switch_d533txexjk == FW_RTH) ||
    ...
    /* '<S8>:2758:3' vom_status=vom_t.FW_RTH; */
    *rty_vom_status = FW_RTH;
    ...
    /* '<S8>:2818:1' sf_internal_predicateOutput = vom_cmd==vom_t.FLTDIR; */
  } else if (system_state_machine_B.Switch_d533txexjk == FLTDIR) {
    /* Transition: '<S8>:2818' */
    system_state_machine_DW.is_FW_Modes =
      system_state_machine_IN_FlightDirector_Mode;

    /* Entry 'FlightDirector_Mode': '<S8>:2746' */
    /* '<S8>:2746:3' vom_status=vom_t.FLTDIR; */
    *rty_vom_status = FLTDIR;
  ...
  *rty_vom_status, busMode_data *rty_mode_data)
{
  ...
  /* '<S8>:2803:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER; */
  if (system_state_machine_B.Switch_d533txexjk == HOVER) {
    /* Transition: '<S8>:2803' */
    ...
    if (((uint32_T)system_state_machine_DW.is_FTransition) ==
    ...
    } else if ((system_state_machine_DW.temporalCounter_i1 >= 100U) &&
               (system_state_machine_DW.hover2FLTDIR)) {
      /* Transition: '<S8>:2787' */
      system_state_machine_DW.is_FTransition =
        system_state_machine_IN_NO_ACTIVE_CHILD;
      ...
      /* '<S8>:2789:1' sf_internal_predicateOutput = (after (1, sec)) && hover2WAYPNT==true; */
               ...
               (system_state_machine_DW.hover2WAYPNT)) {
      /* Transition: '<S8>:2789' */
      system_state_machine_DW.is_FTransition =
        system_state_machine_IN_NO_ACTIVE_CHILD;
    ...
    switch (system_state_machine_DW.exit_port_index_FTransition) {
     ...
     case 4:
      ...
      /* '<S8>:2796:3' vom_status=vom_t.WAYPNT; */
      *rty_vom_status = WAYPNT;
  ...
  *rty_mode_data)
{
  ...
  /* '<S8>:2816:1' sf_internal_predicateOutput = (vom_cmd==vom_t.LOITER &&bTelemtryLinkLoss5sec==false && ... */
  ...
  if (((system_state_machine_B.Switch_d533txexjk == LOITER) &&
    ...
    *heading_ieyh5igw0r = *rtu_sensor_chi;
    ...
    if (system_state_machine_DW.exit_port_index_FW_RTH == 2U) {
  ...
  *rty_mode_data)
{
  ...
  /* '<S8>:2188:4' vom_status=vom_t.HOVER; */
  *rty_vom_status = HOVER;
  ...
  *rty_vom_status, busMode_data *rty_mode_data)
{
  ...
  switch (system_state_machine_DW.is_FW_Modes) {
   case system_state_machine_IN_BackTransition:
    ...
    timecheck = (system_state_machine_DW.temporalCounter_i1 >= 6000U);
    if (((uint32_T)system_state_machine_DW.is_BackTransition) ==
      ...
      if (((*rtu_sensor_aspd_cas) < 10.0) &&
          (system_state_machine_DW.temporalCounter_i2 >= 100U)) {
        /* Transition: '<S8>:2728' */
   ...
   case system_state_machine_IN_FlightDirector_Mode:
    ...
    /* '<S8>:2802:1' sf_internal_predicateOutput = vom_cmd==vom_t.LOITER; */
    switch (system_state_machine_B.Switch_d533txexjk) {
     ...
     case HOVER:
      /* '<S8>:2801:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER; */
      /* Transition: '<S8>:2801' */
      system_state_machine_DW.temporalCounter_i1 = 0U;
      system_state_machine_DW.is_FW_Modes =
        system_state_machine_IN_BackTransition;
     ...
     default:
      ...
      /* '<S8>:2798:1' sf_internal_predicateOutput = vom_cmd==vom_t.FW_RTH... */
      /* '<S8>:2798:2' || bTelemtryLinkLoss5sec==true; */
      if ((system_state_machine_B.Switch_d533txexjk == FW_RTH) ||
          (system_state_machine_DW.bTelemtryLinkLoss5sec)) {
        /* Transition: '<S8>:2798' */
        system_state_machine_DW.is_FW_Modes = system_state_machine_IN_FW_RTH;
        ...
        *rty_vom_status = FW_RTH;
        ...
        /* '<S8>:2815:1' sf_internal_predicateOutput = vom_cmd==vom_t.WAYPNT && wp_list_valid; */
      } else if ((system_state_machine_B.Switch_d533txexjk == WAYPNT) &&
   ...
   case system_state_machine_IN_Loiter_Mode:
    ...
    /* '<S8>:2825:1' sf_internal_predicateOutput = vom_cmd==vom_t.FLTDIR; */
    if (system_state_machine_B.Switch_d533txexjk == FLTDIR) {
      /* Transition: '<S8>:2825' */
      ...
      *rty_vom_status = FLTDIR;
      ...
      /* '<S8>:2821:1' sf_internal_predicateOutput = vom_cmd==vom_t.WAYPNT && wp_list_valid==true; */
    } else if ((system_state_machine_B.Switch_d533txexjk == WAYPNT) &&
               (*rtu_wp_data_wp_list_valid)) {
      /* Transition: '<S8>:2821' */
      /* Exit 'Loiter_Mode': '<S8>:2748' */
      ...
      *rty_vom_status = WAYPNT;
      ...
      /* '<S8>:2806:1' sf_internal_predicateOutput = vom_cmd==vom_t.FW_RTH; */
    } else if (system_state_machine_B.Switch_d533txexjk == FW_RTH) {
      /* Transition: '<S8>:2806' */
      guard1 = true;

      /* Transition: '<S8>:2822' */
      /* '<S8>:2805:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER; */
    } else if (system_state_machine_B.Switch_d533txexjk == HOVER) {
      /* Transition: '<S8>:2805' */
      /* Transition: '<S8>:2823' */
      /* Exit 'Loiter_Mode': '<S8>:2748' */
  ...
  switch (system_state_machine_DW.exit_port_index_FW_Modes) {
   case 2:
    ...
    /* Entry 'RTH': '<S8>:1035' */
    /* '<S8>:1035:3' vom_status=vom_t.MR_RTH; */
    *rty_vom_status = MR_RTH;
  ...
  busMode_data *rty_mode_data)
{
  ...
  /* Transition: '<S8>:141' */
  /* Transition: '<S8>:156' */
  /* '<S8>:139:1' sf_internal_predicateOutput = vom_cmd==vom_t.MANUAL || (iRCoverride==1 && sContingencyFlags.ep_data_loss==0 ); */
  if ((system_state_machine_B.Switch_d533txexjk == MANUAL) ||
      (((*rtu_pilot_input_switch_1) == 1) &&
       (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss)))
  {
    ...
    /* Entry 'MANUAL': '<S8>:276' */
    /* '<S8>:276:3' vom_status=vom_t.MANUAL; */
    *rty_vom_status = MANUAL;

    /* '<S8>:153:1' sf_internal_predicateOutput = vom_cmd==vom_t.LAND; */
  } else if (system_state_machine_B.Switch_d533txexjk == LAND) {
    /* Transition: '<S8>:153' */
    /* Exit Internal 'HOVER': '<S8>:280' */
    system_state_machine_DW.is_HOVER = system_state_machine_IN_NO_ACTIVE_CHILD;
    ...
    /* '<S8>:281:2' vom_status=vom_t.LAND; */
    *rty_vom_status = LAND;
    ...
    /* '<S8>:1036:1' sf_internal_predicateOutput = (bHover5sec==true) || vom_cmd==vom_t.MR_RTH; */
  } else if ((system_state_machine_DW.bHover5sec) ||
             (system_state_machine_B.Switch_d533txexjk == MR_RTH)) {
    /* Transition: '<S8>:1036' */
    /* Exit Internal 'HOVER': '<S8>:280' */
    system_state_machine_DW.is_HOVER = system_state_machine_IN_NO_ACTIVE_CHILD;
    ...
    *rty_vom_status = MR_RTH;
    ...
    if ((system_state_machine_DW.bHover2WPN_yaw_aligned) &&
      ...
      /* '<S8>:2340:1' sf_internal_predicateOutput = vom_cmd==vom_t.FLTDIR && dGroundSpeed_mps <=2; */
    } else if ((system_state_machine_B.Switch_d533txexjk == FLTDIR) &&
               (system_state_machine_B.Max <= 2.0)) {
      /* Transition: '<S8>:2340' */
    ...
    if (guard1) {
      ...
      /* Transition: '<S8>:2809' */
      system_state_machine_DW.is_FW_Modes = system_state_machine_IN_FTransition;

      /* Entry 'FTransition': '<S8>:2777' */
      /* '<S8>:2777:4' vom_status=vom_t.F_TRANS; */
      *rty_vom_status = F_TRANS;
  ...
  *rty_mode_data, pic_t *rty_pic_status)
{
  ...
  /* Transition: '<S8>:140' */
  /* '<S8>:137:1' sf_internal_predicateOutput = (bInAirFlag==0 && vom_cmd==vom_t.READY) || ... */
  /* '<S8>:137:2' ((bInAirFlag==0 && (sContingencyFlags.gps_loss == 1 || sContingencyFlags.ep_data_loss==1 || sContingencyFlags.gcs_link_loss==1))); */
  tmp = !system_state_machine_B.bInAirFlag;
  if ((tmp && (system_state_machine_B.Switch_d533txexjk == READY)) || (tmp &&
        ...
        (system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gcs_link_loss))))
  {
    ...
    /* Entry 'READY': '<S8>:277' */
    /* '<S8>:277:3' vom_status=vom_t.READY; */
    *rty_vom_status = READY;
    ...
    /* Transition: '<S8>:145' */
    /* '<S8>:142:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER && iRCoverride==0; */
  } else if ((system_state_machine_B.Switch_d533txexjk == HOVER) &&
             ((*rtu_pilot_input_switch_1) == 0)) {
    /* Transition: '<S8>:142' */
    /* Transition: '<S8>:152' */
    /* Exit 'MANUAL': '<S8>:276' */
    /* '<S8>:276:5' if bRecoverGPS==1 */
    ...
    /* Transition: '<S8>:146' */
    /* '<S8>:148:1' sf_internal_predicateOutput = vom_cmd==vom_t.LAND && iRCoverride==0; */
  } else if (((system_state_machine_B.Switch_d533txexjk == LAND) &&
              ((*rtu_pilot_input_switch_1) == 0)) ||
             ((system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss)
    ...
    *rty_vom_status = LAND;
    ...
    /* '<S8>:1082:2'   (ip_loss250ms==true&&pic_status == pic_t.INTERNAL) || (vom_cmd==vom_t.MR_RTH&& iRCoverride==0); */
  ...
  *rty_sFlags_rampup_phase)
{
  ...
  if (((((system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss)
       ...
       ||
       (system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gcs_link_loss))
      || (system_state_machine_B.Switch_d533txexjk == READY)) {
    /* Transition: '<S8>:333' */
    ...
    *rty_sFlags_rampup_phase = false;
    ...
    /* '<S8>:272:3' vom_status=vom_t.TAKEOFF; */
    *rty_vom_status = TAKEOFF;
    ...
    *rty_sFlags_rampup_phase = false;
    ...
    /* Entry 'UMAN': '<S8>:1367' */
    /* '<S8>:1367:3' vom_status=vom_t.UMAN; */
    *rty_vom_status = UMAN;
  } else if (((uint32_T)system_state_machine_DW.is_STARTUP) ==
             system_state_machine_IN_NOMINAL) {
    /* During 'NOMINAL': '<S8>:2826' */
    /* '<S8>:2828:1' sf_internal_predicateOutput = vom_cmd==vom_t.TAKEOFF; */
    guard1 = false;
    if (system_state_machine_B.Switch_d533txexjk == TAKEOFF) {
      /* Transition: '<S8>:2828' */
      /* '<S8>:2828:1' startup2takeoff=true; */
      system_state_machine_DW.startup2takeoff = true;
      guard1 = true;

      /* '<S8>:2829:1' sf_internal_predicateOutput = vom_cmd==vom_t.MANUAL; */
    } else if (system_state_machine_B.Switch_d533txexjk == MANUAL) {
      /* Transition: '<S8>:2829' */
      /* '<S8>:2829:1' startup2manual=true; */
      system_state_machine_DW.startup2manual = true;
      guard1 = true;

      /* '<S8>:2827:1' sf_internal_predicateOutput = vom_cmd==vom_t.UMAN; */
    } else if (system_state_machine_B.Switch_d533txexjk == UMAN) {
      /* Transition: '<S8>:2827' */
  ...
  rty_loiter_mode, pic_t *rty_pic_status)
{
  ...
  switch (system_state_machine_DW.is_FMM) {
   case system_state_machine_IN_AUTOLAND:
    ...
    /* Transition: '<S8>:147' */
    /* '<S8>:151:1' sf_internal_predicateOutput = ((vom_cmd==vom_t.MANUAL) && ep_loss250ms==false) || (iRCoverride==1 && sContingencyFlags.ep_data_loss==0 ); */
    if (((system_state_machine_B.Switch_d533txexjk == MANUAL) &&
         ...
         (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss)))
    {
      ...
      *rty_vom_status = MANUAL;
      ...
      /* '<S8>:138:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER&&(h_radar_AGL >=1)&&bHover5sec==false || bRecoverGPS==1; */
    } else if ((((system_state_machine_B.Switch_d533txexjk == HOVER) &&
                 ((*rtu_sensor_h_radar_agl) >= 1.0)) &&
      ...
      /* Transition: '<S8>:160' */
      /* '<S8>:144:1' sf_internal_predicateOutput = (vom_cmd==vom_t.READY); */
    } else if (system_state_machine_B.Switch_d533txexjk == READY) {
      /* Transition: '<S8>:144' */
      system_state_machine_DW.is_FMM = system_state_machine_IN_READY;
   ...
   case system_state_machine_IN_AUTOTAKEOFF:
    ...
    /* Transition: '<S8>:158' */
    /* Transition: '<S8>:149' */
    /* '<S8>:157:1' sf_internal_predicateOutput = (bInAirFlag==0 && vom_cmd==vom_t.READY) || ... */
    ...
    out = !system_state_machine_B.bInAirFlag;
    if ((out && (system_state_machine_B.Switch_d533txexjk == READY)) || (out &&
         ((((system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss)
            ||
            (system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss))
           ||
                ...
                (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss)))
    {
      ...
      *rty_vom_status = MANUAL;
      ...
      /* '<S8>:135:1' sf_internal_predicateOutput = vom_cmd==vom_t.HOVER && (dCapturedAlt_m>=1); */
    } else if (((system_state_machine_B.Switch_d533txexjk == HOVER) &&
                (system_state_machine_B.Add >= 1.0)) ||
               (system_state_machine_DW.bRecoverGPS == 1.0)) {
      /* Transition: '<S8>:135' */
      /* Transition: '<S8>:1322' */
      guard2 = true;
    } else {
      /* '<S8>:1322:1' sf_internal_predicateOutput = bRecoverGPS==1; */
    }
    break;
   ...
   case system_state_machine_IN_READY:
    /* During 'READY': '<S8>:277' */
    /* '<S8>:136:1' sf_internal_predicateOutput = vom_cmd==vom_t.STARTUP&& ... */
    ...
    if (((((system_state_machine_B.Switch_d533txexjk == STARTUP) &&
           (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss))
          &&
          (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss))
         &&
        ...
        (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gcs_link_loss))
    {
      ...
      /* '<S8>:279:3' vom_status=vom_t.STARTUP; */
      *rty_vom_status = STARTUP;
   ...
   case system_state_machine_IN_RTH:
    ...
    out = ((*Switch1) && (!(*rty_sFlags_bGPSLoss)));
    if (out) {
      /* Transition: '<S8>:1065' */
      ...
      *rty_vom_status = LAND;
      ...
      /* '<S8>:1091:1' sf_internal_predicateOutput = (vom_cmd==vom_t.MANUAL && ep_loss250ms==false) || (iRCoverride==1 && sContingencyFlags.ep_data_loss==0 ); */
    } else if (((system_state_machine_B.Switch_d533txexjk == MANUAL) &&
                (!system_state_machine_DW.ep_loss250ms)) ||
               (((*rtu_pilot_input_switch_1) == 1) &&
                (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss)))
      ...
      switch (system_state_machine_DW.is_RTH) {
       case system_state_machine_IN_RTH_Alt_Check:
        ...
        if (rtu_sensor_pos_lla[2] > (rty_mode_data->rth_data.rth_alt_agl - 1.0))
        {
          ...
          rty_mode_data->rth_data.rth_yaw_ref = *TrigonometricFunction6;
        }
        break;
       ...
       case system_state_machine_IN_RTH_Heading_Check:
        ...
        system_state_machine_lkpmp3sm0z((*TrigonometricFunction6) -
          rtu_sensor_eul_ang[2], &Abs,
       ...
       default:
        ...
        if (system_state_machine_B.Max < 3.0) {
          ...
          /* '<S8>:1045:4' sMode_data.rth_data.rth_alt_agl=dHomeLLA(3)+30; */
   ...
   default:
    /* During 'UMAN': '<S8>:1367' */
    /* '<S8>:1371:1' sf_internal_predicateOutput = vom_cmd==vom_t.MR_RTH; */
    if (system_state_machine_B.Switch_d533txexjk == MR_RTH) {
      /* Transition: '<S8>:1371' */
      guard1 = true;

      /* '<S8>:1344:1' sf_internal_predicateOutput = (vom_cmd==vom_t.READY); */
    } else if (system_state_machine_B.Switch_d533txexjk == READY) {
      /* Transition: '<S8>:1344' */
      /* Transition: '<S8>:1345' */
      system_state_machine_DW.is_FMM = system_state_machine_IN_READY;
      ...
      *rty_vom_status = READY;
      ...
      /* '<S8>:1373:1' sf_internal_predicateOutput = loiter_mode==1&&ep_loss5sec==true&&bTelemtryLinkLoss5sec==true; */
      out = ((((*rty_loiter_mode) == 1U) && (system_state_machine_DW.ep_loss5sec))
             && (system_state_machine_DW.bTelemtryLinkLoss5sec));
      if (out) {
        /* Transition: '<S8>:1373' */
        guard1 = true;
      } else {
        /* '<S8>:1377:1' sf_internal_predicateOutput = loiter_mode==0&&bTelemtryLinkLoss1sec==true&&ep_loss1sec==true; */
        out = ((((*rty_loiter_mode) == 0U) && (*rty_sFlags_bTelemtryLinkLoss1sec))
  ...
  boolean_T *rty_bInAirFlag)
{
  ...
  switch (system_state_machine_DW.is_InAirOnGroundLogic) {
    ...
    *rty_bInAirFlag = true;
    ...
    /* Constant: '<S1>/mass' */
    /* During 'InAir': '<S8>:251' */
    /* '<S8>:252:1' sf_internal_predicateOutput = (h_radar_AGL<0.6 ) && (f_mode_unitdelay==vom_t.LAND || f_mode_unitdelay==vom_t.MANUAL || f_mode_unitdelay == vom_t.UMAN) && forceDes<= (0.2*mass*9.81); */
    if ((((*rtu_sensor_h_radar_agl) < 0.6) && ((((*vom_status) == LAND) ||
           ((*vom_status) == MANUAL)) || ((*vom_status) == UMAN))) &&
        ((*rtu_controllerAltCtrl_forceDes) <= 128.41290000000004)) {
      /* Transition: '<S8>:252' */
    ...
    *rty_bInAirFlag = false;
    ...
    /* '<S8>:1103:1' sf_internal_predicateOutput = dCapturedAlt_m>=0.6 && forceDes>= (0.8*mass*9.81) && (f_mode_unitdelay==vom_t.TAKEOFF || f_mode_unitdelay==vom_t.MANUAL || f_mode_unitdelay == vom_t.UMAN); */
    if (((system_state_machine_B.Add >= 0.6) &&
         ((*rtu_controllerAltCtrl_forceDes) >= 513.65160000000014)) &&
        ((((*vom_status) == TAKEOFF) || ((*vom_status) == MANUAL)) ||
         ((*vom_status) == UMAN))) {
      /* Transition: '<S8>:1103' */
      system_state_machine_DW.temporalCounter_i3 = 0U;
      system_state_machine_DW.is_InAirOnGroundLogic =
   ...
   case system_state_machine_IN_altitude_check_1:
    ...
    if (system_state_machine_DW.temporalCounter_i3 >= 50U) {
      /* Transition: '<S8>:248' */
      system_state_machine_DW.is_InAirOnGroundLogic =
      ...
      *rty_bInAirFlag = true;
      ...
      /* Constant: '<S1>/mass' */
      /* '<S8>:1235:1' sf_internal_predicateOutput = dCapturedAlt_m<0.6 || forceDes< (0.8*mass*9.81)|| ~(f_mode_unitdelay == vom_t.TAKEOFF || f_mode_unitdelay == vom_t.MANUAL || f_mode_unitdelay == vom_t.UMAN); */
    } else if (((system_state_machine_B.Add < 0.6) ||
                ((*rtu_controllerAltCtrl_forceDes) < 513.65160000000014)) ||
               ((((*vom_status) != TAKEOFF) && ((*vom_status) != MANUAL)) &&
                ((*vom_status) != UMAN))) {
      /* Transition: '<S8>:1235' */
   ...
   default:
    ...
    if (system_state_machine_DW.temporalCounter_i3 >= 100U) {
      /* Transition: '<S8>:1106' */
      system_state_machine_DW.is_InAirOnGroundLogic =
        system_state_machine_IN_OnGround;
      ...
      *rty_bInAirFlag = false;
      ...
      /* Constant: '<S1>/mass' */
      /* '<S8>:1237:1' sf_internal_predicateOutput = h_radar_AGL>0.6 || forceDes > (0.2*mass*9.81) || ~(f_mode_unitdelay==vom_t.LAND || f_mode_unitdelay==vom_t.MANUAL || f_mode_unitdelay == vom_t.UMAN); */
    } else if ((((*rtu_sensor_h_radar_agl) > 0.6) ||
                ((*rtu_controllerAltCtrl_forceDes) > 128.41290000000004)) ||
               ((((*vom_status) != LAND) && ((*vom_status) != MANUAL)) &&
                ((*vom_status) != UMAN))) {
      /* Transition: '<S8>:1237' */
      system_state_machine_DW.is_InAirOnGroundLogic =
        system_state_machine_IN_InAir;
  ...
  *rty_sFlags_bTelemtryLinkLoss1sec, boolean_T *rty_sFlags_ep_loss1sec)
{
  ...
  switch (system_state_machine_DW.is_HoverTimer) {
   ...
   default:
    ...
    /* '<S8>:660:1' sf_internal_predicateOutput = f_mode_unitdelay==vom_t.HOVER && (bTelemtryLinkLoss5sec || (ep_loss5sec&&ip_loss5sec)); */
    if (((*vom_status) == HOVER) &&
        ((system_state_machine_DW.bTelemtryLinkLoss5sec) ||
         ((system_state_machine_DW.ep_loss5sec) &&
          (system_state_machine_DW.ip_loss5sec)))) {
    ...
    *rty_sFlags_bGPSLoss = true;
        ...
        (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss)
    {
      ...
      *rty_sFlags_bGPSLoss10sec = false;
      ...
      /* '<S8>:827:4' bGPSLoss2sec=false; */
      system_state_machine_DW.bGPSLoss2sec = false;

      /* '<S8>:827:5' bGPSLoss=false; */
      *rty_sFlags_bGPSLoss = false;

      /* '<S8>:827:6' timer_GPSLoss=0; */
  ...
  pic_t *rty_pic_status, uint8_T *rty_CoG_tracking)
{
  ...
  system_state_machine_phh325i5jc(TrigonometricFunction6, Switch1,
    rtu_sensor_eul_ang, rtu_sensor_pos_lla, rtu_sensor_aspd_cas,
    rtu_sensor_h_radar_agl, rtu_sensor_chi, rtu_pilot_input_switch_1,
    rtu_wp_data_wp_list_valid, rty_vom_status, rty_mode_data,
    rty_sFlags_bGPSLoss, rty_sFlags_rampup_phase,
    rty_sFlags_bTelemtryLinkLoss1sec, rty_sFlags_ep_loss1sec, rty_loiter_mode,
    rty_pic_status);
  system_state_machine_hkbbt45tg5(vom_status, rtu_sensor_h_radar_agl,
    rtu_controllerAltCtrl_forceDes, rty_bInAirFlag);
  ...
  switch (system_state_machine_DW.is_Safety_SM) {
   case system_state_machine_IN_ARMED:
    ...
    if ((*FixPtRelationalOperator_cwrqbb5ufj) ||
        (((((system_state_machine_DW.bTelemtryLinkLoss5sec) &&
            (system_state_machine_DW.ep_loss5sec)) &&
           (system_state_machine_DW.ip_loss5sec)) &&
          (system_state_machine_DW.bGPSLoss2sec)) || ((*rty_vom_status) == READY)))
    {
      /* Transition: '<S8>:996' */
      /* Transition: '<S8>:1399' */
      /* Transition: '<S8>:2836' */
      ...
      /* '<S8>:954:2' safety_state=safety_state_t.DISARMED; */
      *rty_safety_state = DISARMED;
      ...
      /* Outputs for Atomic SubSystem: '<Root>/system_state_machine' */
      /* Chart: '<S1>/fcs_state_machine_stateflow' */
      /* '<S8>:2836:1' sf_internal_predicateOutput = vom_status==vom_t.READY; */
      /* '<S8>:993:2' safety_state=safety_state_t.ARMED; */
      *rty_safety_state = ARMED;
   ...
   case system_state_machine_IN_DISARMED:
    ...
    /* '<S8>:1001:1' sf_internal_predicateOutput = f_mode_unitdelay==vom_t.READY && vom_status==vom_t.STARTUP; */
    c_out = (((*vom_status) == READY) && ((*rty_vom_status) == STARTUP));
   ...
   default:
    ...
    /* '<S8>:1002:1' sf_internal_predicateOutput = safety_state_time<2000  && ARM_knob_risingedge>0; */
    if ((system_state_machine_DW.safety_state_time < 2000.0) &&
      ...
      *rty_safety_state = ARMED;
      ...
      /* '<S8>:1003:1' sf_internal_predicateOutput = safety_state_time>2000; */
    } else if (system_state_machine_DW.safety_state_time > 2000.0) {
      /* Transition: '<S8>:1003' */
      system_state_machine_DW.is_Safety_SM = system_state_machine_IN_DISARMED;
  ...
  if (((uint32_T)system_state_machine_DW.is_Loiter_SM) ==
    ...
    *rty_loiter_mode = 0U;
    ...
    /* '<S8>:1355:1' sf_internal_predicateOutput = loiter_cmd==1 && dGroundSpeed_mps>4 && (abs(Chi_Yaw_err) < pi/6) && sContingencyFlags.gps_loss==false && iRCoverride==0; */
    if ((((*Switch) == 1.0) && (system_state_machine_B.Max > 4.0)) && ((fabs
    ...
    *rty_loiter_mode = 1U;
    ...
    /* '<S8>:1356:1' sf_internal_predicateOutput = loiter_cmd==0 || (abs(Chi_Yaw_err) > 80*pi/180) ||dGroundSpeed_mps<3 || sContingencyFlags.gps_loss==true || iRCoverride==1; */
    if (((*Switch) == 0.0) || ((fabs(system_state_machine_B.Add4) >
          1.3962634015954636) || (((system_state_machine_B.Max < 3.0) ||
           (system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss))
          || ((*rtu_pilot_input_switch_1) == 1)))) {
      /* Transition: '<S8>:1356' */
  ...
  if (((uint32_T)system_state_machine_DW.is_TECS_SM) ==
    ...
    *rty_lifter_state = ON;
    ...
    /* '<S8>:1363:1' sf_internal_predicateOutput = TECS_cmd == 1 && dAirspeedCAS > 18 && vom_status==vom_t.UMAN && sContingencyFlags.gps_loss==false && iRCoverride==0; */
    c_out = ((((((*rtu_extd_cmd_tecs_cmd) == 1U) && ((*rtu_sensor_aspd_cas) >
      18.0)) && ((*rty_vom_status) == UMAN)) &&
              (!system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss))
             && ((*rtu_pilot_input_switch_1) == 0));
    ...
    *rty_lifter_state = OFF;
    ...
    if ((((*rtu_extd_cmd_tecs_cmd) == 0U) || ((*rtu_sensor_aspd_cas) < 16.0)) ||
        (((system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.gps_loss)
          || ((*rtu_pilot_input_switch_1) == 1)) || ((*rty_vom_status) != UMAN)))
    {
      /* Transition: '<S8>:1364' */
      /* Transition: '<S8>:1440' */
      /* Transition: '<S8>:1441' */
      ...
      *rty_lifter_state = ON;
      ...
      /* '<S8>:1441:1' sf_internal_predicateOutput = vom_status~=vom_t.UMAN; */
    }
  ...
  if (((uint32_T)system_state_machine_DW.is_PIC_SM) ==
    ...
    *rty_pic_status = EXTERNAL;
    ...
    if ((system_state_machine_B.Switch_po1f1vqhhu == INTERNAL) && c_out) {
      ...
      /* Outputs for Atomic SubSystem: '<Root>/system_state_machine' */
      /* Chart: '<S1>/fcs_state_machine_stateflow' */
      /* '<S8>:2337:1' sf_internal_predicateOutput =  (ep_loss1sec ==true && sContingencyFlags.ip_data_loss==false)&&(f_mode_unitdelay ~=vom_t.MANUAL); */
      c_out = (((*rty_sFlags_ep_loss1sec) && c_out) && ((*vom_status) != MANUAL));
    ...
    *rty_pic_status = INTERNAL;
    ...
    /* '<S8>:1416:1' sf_internal_predicateOutput =  (iRCoverride==1 && sContingencyFlags.ep_data_loss==false && (f_mode_unitdelay ==vom_t.HOVER || f_mode_unitdelay ==vom_t.MANUAL || f_mode_unitdelay ==vom_t.TAKEOFF || f_mode_unitdelay ==vom_t.LAND )); */
    c_out =
      !system_state_machine_B.BusConversion_InsertedFor_fcs_state_machine_stateflow_nqsisctbxb.ep_data_loss;
    if ((((((*rtu_pilot_input_switch_1) == 1) && c_out) && (((((*vom_status) ==
              HOVER) || ((*vom_status) == MANUAL)) || ((*vom_status) == TAKEOFF))
           || ((*vom_status) == LAND))) ||
  ...
  if (((uint32_T)system_state_machine_DW.is_CoG_SM) ==
    ...
    *rty_CoG_tracking = 0U;
    ...
    /* '<S8>:1424:1' sf_internal_predicateOutput = (vom_status==vom_t.UMAN || vom_status==vom_t.F_TRANS || vom_status==vom_t.FLTDIR || vom_status==vom_t.LOITER  ) && dGroundSpeed_mps>8 && abs(Chi_Yaw_err) < 20*pi/180; */
    c_out = (((((((*rty_vom_status) == UMAN) || ((*rty_vom_status) == F_TRANS)) ||
                ((*rty_vom_status) == FLTDIR)) || ((*rty_vom_status) == LOITER))
              && (system_state_machine_B.Max > 8.0)) && (fabs
              (system_state_machine_B.Add4) < 0.3490658503988659));
    ...
    *rty_CoG_tracking = 1U;
    ...
    /* '<S8>:1426:1' sf_internal_predicateOutput = (vom_status~=vom_t.UMAN && vom_status~=vom_t.F_TRANS && vom_status~=vom_t.FLTDIR  ) || (abs(Chi_Yaw_err) > 80*pi/180) || dGroundSpeed_mps<6 || bGPSLoss==true; */
    c_out = (((((*rty_vom_status) != UMAN) && ((*rty_vom_status) != F_TRANS)) &&
              ((*rty_vom_status) != FLTDIR)) || ((fabs
               (system_state_machine_B.Add4) > 1.3962634015954636) ||
              ((system_state_machine_B.Max < 6.0) || (*rty_sFlags_bGPSLoss))));
  ...
  uint8_T *rty_CoG_tracking)
{
  ...
  system_state_machine_DW.UnitDelay1_DSTATE_jsa3d2gsdq = READY;
  ...
  pic_t *rty_pic_status, uint8_T *rty_CoG_tracking)
{
  ...
  real_T TrigonometricFunction6;
  real_T rtb_Sqrt_hi0btguyea;
  real_T rtb_Switch;
  real_T rtb_Switch_pjqesw53bu;
  real_T rtb_TrigonometricFunction1_hpo0jul1uy;
   ...
   */
  if ((*rtu_std_command_vom_cmd) != READY) {
  ...
  /* Sum: '<S2>/Add' */
  system_state_machine_B.Add = rtu_sensor_pos_lla[2] - rtb_Switch;
   ...
   */
  rtb_Compare_d1opexicre = ((*rtu_std_command_vom_cmd) == STARTUP);
  ...
  system_state_machine_DW.icLoad = ((rtb_FixPtRelationalOperator && (((uint32_T)
   ...
   *  Constant: '<S6>/ADSAC_Runway'
   *  Delay: '<S6>/Delay One Step1'
   */
  system_state_machine_B.sLLA[0] = 0.43152217336278126;
  system_state_machine_B.sLLA[1] = 0.95703189599645466;
  system_state_machine_B.sLLA[2] = system_state_machine_DW.DelayOneStep1_DSTATE;

  /* Sum: '<S10>/Add' */
  rtb_TrigonometricFunction2 = 0.95703189599645466 - rtu_sensor_pos_lla[1];
   ...
   */
  TrigonometricFunction6 = atan2(0.90833014724679306 * sin
    (rtb_TrigonometricFunction2), (cos(rtu_sensor_pos_lla[0]) *
    0.41825392239956249) - ((sin(rtu_sensor_pos_lla[0]) * 0.90833014724679306) *
  ...
  /*  C_e_n as */
  /*  Calculate ECEF to NED coordinate transformation matrix using (2.150) */
  /* MATLAB Function 'pos_NED/ECEF2NED/MATLAB Function1': '<S27>:1' */
  /* '<S27>:1:6' cos_lat = cos(LLA(1)); */
  /* '<S27>:1:7' sin_lat = sin(LLA(1)); */
  /* '<S27>:1:8' cos_long = cos(LLA(2)); */
  /* '<S27>:1:9' sin_long = sin(LLA(2)); */
  /* '<S27>:1:10' C = [-sin_lat * cos_long, -sin_lat * sin_long,  cos_lat;... */
  /* '<S27>:1:11'                    -sin_long,            cos_long,        0;... */
  /* '<S27>:1:12'          -cos_lat * cos_long, -cos_lat * sin_long, -sin_lat]; */
  rtb_TrigonometricFunction1_hpo0jul1uy = rtu_sensor_pos_lla[2] +
    6.381874970818636E+6;
   ...
   *  Constant: '<S28>/e'
   */
  rtb_Sqrt_hi0btguyea = rtb_Switch_pjqesw53bu * 0.0818191908425;
   ...
   *  Sum: '<S28>/Add'
   */
  rtb_Sqrt_hi0btguyea = sqrt(1.0 - (rtb_Sqrt_hi0btguyea * rtb_Sqrt_hi0btguyea));

  /* Switch: '<S29>/Switch3' incorporates:
   *  Abs: '<S29>/Abs'
   *  Product: '<S29>/Product'
   */
  if (rtb_Sqrt_hi0btguyea <= 0.001) {
    rtb_Sqrt_hi0btguyea = -0.001;
  }
   ...
   *  Constant: '<S28>/R_0'
   */
  rtb_Sqrt_hi0btguyea = 6.378137E+6 / rtb_Sqrt_hi0btguyea;
   ...
   */
  rtb_TrigonometricFunction2 = (rtb_Sqrt_hi0btguyea + rtu_sensor_pos_lla[2]) *
    cos(rtu_sensor_pos_lla[0]);
  rtb_Product_invsy3i2yj[0] = rtb_TrigonometricFunction2 * cos
    (rtu_sensor_pos_lla[1]);

  /* Product: '<S25>/Product1' incorporates:
   *  Trigonometry: '<S25>/Trigonometric Function2'
   */
  rtb_Product_invsy3i2yj[1] = rtb_TrigonometricFunction2 * sin
    (rtu_sensor_pos_lla[1]);
   ...
   */
  rtb_TrigonometricFunction2 = (0.993305620009879 * rtb_Sqrt_hi0btguyea) +
    rtu_sensor_pos_lla[2];

  /* MATLAB Function: '<S24>/MATLAB Function1' */
  sin_lat[0] = -0.24089288737373216;
  sin_lat[3] = -0.34191659862511159;
  sin_lat[6] = 0.90833014724679306;
  sin_lat[1] = -0.8174856954442975;
  sin_lat[4] = 0.57594890202513049;
  sin_lat[7] = 0.0;
  sin_lat[2] = -0.52315175098311562;
  sin_lat[5] = -0.7425469021150658;
  sin_lat[8] = -0.41825392239956249;
   ...
   */
  rtb_Sqrt_hi0btguyea = rtb_Product_invsy3i2yj[0] -
    ((rtb_TrigonometricFunction1_hpo0jul1uy * 0.90833014724679306) *
     0.57594890202513049);
  rtb_TrigonometricFunction1_hpo0jul1uy = rtb_Product_invsy3i2yj[1] -
    ((rtb_TrigonometricFunction1_hpo0jul1uy * 0.90833014724679306) *
     0.8174856954442975);
  rtb_Switch_pjqesw53bu = (rtb_Switch_pjqesw53bu * rtb_TrigonometricFunction2) -
    (0.41825392239956249 * (rtu_sensor_pos_lla[2] + 6.3391522747145332E+6));

  /* Product: '<S24>/Product' */
  for (i = 0; i < 3; i++) {
    /* Product: '<S24>/Product' */
    rtb_Product_invsy3i2yj[i] = ((sin_lat[i] * rtb_Sqrt_hi0btguyea) + (sin_lat[i
      + 3] * rtb_TrigonometricFunction1_hpo0jul1uy)) + (sin_lat[i + 6] *
      rtb_Switch_pjqesw53bu);
  }
   ...
   *  Sum: '<S23>/Add'
   */
  rtb_Switch_pjqesw53bu = sqrt((rtb_Product_invsy3i2yj[0] *
    rtb_Product_invsy3i2yj[0]) + (rtb_Product_invsy3i2yj[1] *
    rtb_Product_invsy3i2yj[1]));
  ...
  if (rtb_FixPtRelationalOperator) {
     ...
     */
    Switch1 = (rtb_Switch_pjqesw53bu <= 10.0);
  } else {
    ...
    if (rtb_FixPtRelationalOperator) {
       ...
       *  Sum: '<S5>/Add1'
       */
      Switch1 = (rtb_Switch_pjqesw53bu <= ((system_state_machine_ConstB.Tan *
        (rtu_sensor_pos_lla[2] - 3.0)) + 1.5));
    } else {
      /* Switch: '<S5>/Switch1' incorporates:
       *  Constant: '<S19>/Constant'
       *  RelationalOperator: '<S19>/Compare'
       */
      Switch1 = (rtb_Switch_pjqesw53bu <= 1.5);
    }
   ...
   *  Store in Global RAM
   */
  if ((*rtu_extd_cmd_loiter_cmd) !=
      system_state_machine_DW.DelayInput1_DSTATE_fuh11wooih) {
    /* Switch: '<S11>/Switch' */
    rtb_TrigonometricFunction2 = (real_T)(*rtu_extd_cmd_loiter_cmd);
  } else {
    /* Switch: '<S11>/Switch' incorporates:
     *  Constant: '<S11>/loiter_cmd '
     */
  ...
  if ((*rtu_std_command_vom_cmd_cnt) >
     ...
     *  Constant: '<S13>/vom_t '
     */
    system_state_machine_B.Switch_d533txexjk = INVALID;
  }

  /* End of Switch: '<S13>/Switch' */

  /* Chart: '<S1>/fcs_state_machine_stateflow' incorporates:
   *  UnitDelay: '<S1>/Unit Delay1'
   */
  if (system_state_machine_DW.temporalCounter_i1 < 8191U) {
    system_state_machine_DW.temporalCounter_i1 = (uint16_T)((int32_T)(((int32_T)
      system_state_machine_DW.temporalCounter_i1) + 1));
  }

  if (system_state_machine_DW.temporalCounter_i2 < 127U) {
    system_state_machine_DW.temporalCounter_i2 = (uint8_T)((int32_T)(((int32_T)
      system_state_machine_DW.temporalCounter_i2) + 1));
  }

  if (system_state_machine_DW.temporalCounter_i3 < 127U) {
  ...
  if (system_state_machine_DW.is_active_c4_system_state_machine == 0U) {
    ...
    *rty_CoG_tracking = 0U;
    ...
    system_state_machine_fhrgqlbunr(&TrigonometricFunction6,
      &FixPtRelationalOperator, &FixPtRelationalOperator_cwrqbb5ufj,
      &system_state_machine_DW.UnitDelay1_DSTATE_jsa3d2gsdq, &Switch1,
      &rtb_TrigonometricFunction2, rtu_sensor_eul_ang, rtu_sensor_pos_lla,
      rtu_sensor_aspd_cas, rtu_sensor_h_radar_agl, rtu_sensor_chi,
      rtu_pilot_input_switch_1, rtu_controllerAltCtrl_forceDes,
      rtu_extd_cmd_tecs_cmd, rtu_wp_data_wp_list_valid, rty_bInAirFlag,
      rty_vom_status, rty_mode_data, rty_sFlags_bGPSLoss10sec,
      rty_sFlags_bGPSLoss, rty_sFlags_rampup_phase,
