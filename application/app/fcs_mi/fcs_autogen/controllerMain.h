...
typedef struct {
  ...
  real_T notch0_gyro_states[6];        /* '<S26>/notch0_gyro' */
  real_T notch0_acc_states[6];         /* '<S26>/notch0_acc' */
  real_T notch0_gyro1_states[6];       /* '<S26>/notch0_gyro1' */
  real_T notch0_acc1_states[6];        /* '<S26>/notch0_acc1' */
  real_T ud_1_DSTATE;                  /* '<S15>/ud' */
  real_T ud_2_DSTATE;                  /* '<S15>/ud' */
  real_T ud_3_DSTATE;                  /* '<S15>/ud' */
  real_T ud_4_DSTATE;                  /* '<S15>/ud' */
  real_T ud_5_DSTATE;                  /* '<S15>/ud' */
  real_T FixPtUnitDelay1_DSTATE;       /* '<S19>/FixPt Unit Delay1' */
  real_T ud1_1_DSTATE;                 /* '<S15>/ud1' */
  real_T ud1_2_DSTATE;                 /* '<S15>/ud1' */
  real_T ud1_3_DSTATE;                 /* '<S15>/ud1' */
  real_T ud1_4_DSTATE;                 /* '<S15>/ud1' */
  real_T ud1_5_DSTATE;                 /* '<S15>/ud1' */
  ...
  real_T omega_DSTATE;                 /* '<S25>/omega' */
  real_T omega_DSTATE_l5hd10dn0e;      /* '<S24>/omega' */
  ...
  real_T PrevY_fbnop0txyt;             /* '<S23>/Rate Limiter' */
  ...
  uint8_T omega_IC_LOADING;            /* '<S25>/omega' */
  uint8_T omega_IC_LOADING_bb503dutix; /* '<S24>/omega' */
} controllerMain_l5cfqqw4qz_T;

/* Invariant block signals (default storage) */
typedef struct {
  const real_T Gain;                   /* '<S15>/Gain' */
  const real_T Sum1;                   /* '<S23>/Sum1' */
  const real_T Abs;                    /* '<S28>/Abs' */
  const real_T Switch1;                /* '<S28>/Switch1' */
  const real_T Product;                /* '<S28>/Product' */
  const real_T Switch3;                /* '<S28>/Switch3' */
...
extern const ext_command_t controllerMain_rtZext_command_t;/* ext_command_t ground */
 ...
 * '<S5>'   : 'controllerMain/Integrator_crossfeed/saturation_handler'
 * '<S6>'   : 'controllerMain/Integrator_crossfeed/saturation_handler1'
 * '<S7>'   : 'controllerMain/Integrator_crossfeed/saturation_handler/Compare To Constant1'
 * '<S8>'   : 'controllerMain/Integrator_crossfeed/saturation_handler/Compare To Constant2'
 * '<S9>'   : 'controllerMain/Integrator_crossfeed/saturation_handler/Compare To Constant3'
 * '<S10>'  : 'controllerMain/Integrator_crossfeed/saturation_handler1/Compare To Constant1'
 * '<S11>'  : 'controllerMain/Integrator_crossfeed/saturation_handler1/Compare To Constant2'
 * '<S12>'  : 'controllerMain/Integrator_crossfeed/saturation_handler1/Compare To Constant3'
 * '<S13>'  : 'controllerMain/Integrator_crossfeed/saturation_handler1/Compare To Constant4'
 * '<S14>'  : 'controllerMain/PilotCmd/Compare To Constant'
 * '<S15>'  : 'controllerMain/PilotCmd/Smooth_Transition'
 * '<S16>'  : 'controllerMain/PilotCmd/Smooth_Transition/Rate_Limiter_Dynamic1'
 * '<S17>'  : 'controllerMain/PilotCmd/Smooth_Transition/Rate_Limiter_Dynamic1/Compare To Constant'
 * '<S18>'  : 'controllerMain/PilotCmd/Smooth_Transition/Rate_Limiter_Dynamic1/Saturation Dynamic'
 * '<S19>'  : 'controllerMain/PilotCmd/Smooth_Transition/Rate_Limiter_Dynamic1/Unit Delay External IC'
 * '<S20>'  : 'controllerMain/Safety/SAFETY'
 * '<S21>'  : 'controllerMain/Safety/SAFETY/Compare To Constant2'
 * '<S22>'  : 'controllerMain/SensorManagement/SpikeEnable'
 * '<S23>'  : 'controllerMain/SensorManagement/airspeedFilter'
 * '<S24>'  : 'controllerMain/SensorManagement/derivativeFilter'
 * '<S25>'  : 'controllerMain/SensorManagement/filter'
 * '<S26>'  : 'controllerMain/SensorManagement/sensor_filtering'
 * '<S27>'  : 'controllerMain/SensorManagement/static_voting_logic'
 * '<S28>'  : 'controllerMain/SensorManagement/zero_division_protection1'
 * '<S29>'  : 'controllerMain/SensorManagement/SpikeEnable/Compare To Constant'
 * '<S30>'  : 'controllerMain/SensorManagement/SpikeEnable/Compare To Constant1'
 * '<S31>'  : 'controllerMain/SensorManagement/SpikeEnable/Compare To Constant2'
 */
